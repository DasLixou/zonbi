...
//!
//! To hold such type-erased value inside for example a box, you can create a [`Cage<'life, Z>`] of the zonbi `Z` and then hold that in a [`dyn AnyZonbi<'life>`][AnyZonbi] with the associated minimal lifetime.
